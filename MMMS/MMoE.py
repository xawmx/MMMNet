...
class MultiModalDataset(Dataset):
    def __init__(self, img_path, text_path, label_paths):
        ...
        self.img_feats = self.img_scaler.fit_transform(self.img_feats)
        self.text_feats = self.text_scaler.fit_transform(self.text_feats)
...
class MultiTaskTrainer:
    ...
    def run(self, epochs):
        ...
        for epoch in range(epochs):
            ...
            print(
                f"Epoch {epoch + 1}/{epochs} | Loss: {train_loss:.4f} | LR: {self.optimizer.param_groups[0]['lr']:.2e}")
